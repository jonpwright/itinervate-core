...
exports.AIRPORT_TIME_ZONE_COUNT = void 0;
exports.airportTimeZone = airportTimeZone;
const AIRPORT_TIME_ZONES = {
    ...
    CUR: 'America/Curacao',
    CUS: 'America/Indiana/Indianapolis',
    ...
    OLR: 'Asia/Kabul',
    OLS: 'America/Phoenix',
    OLU: 'America/Indiana/Indianapolis',
    OLV: 'America/Chicago',
    OLX: 'Africa/Nairobi',
    OLY: 'America/Chicago',
    OLZ: 'Asia/Yakutsk',
 ...
 */
function airportTimeZone(iata) {
    if (typeof iata !== 'string')
        return undefined;
    const code = iata.trim().toUpperCase();
    if (!/^[A-Z]{3}$/.test(code))
        return undefined;
    return AIRPORT_TIME_ZONES[code];
}
/** Number of airports covered — asserted in tests to catch accidental truncation. */
exports.AIRPORT_TIME_ZONE_COUNT = Object.keys(AIRPORT_TIME_ZONES).length;
